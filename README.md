...
O ambiente recomendado de utilização deste projeto é o codespace do github, uma vez que ele já possui um terminal linux com diversos programas úties instalados como git, docker, ... Além disso, já existe uma conexão com o repositório github em questão.
